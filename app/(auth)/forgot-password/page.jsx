...
export default function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                showToast("Success", "Reset OTP sent to your email", "success");
            ...
            <main className="flex-grow flex items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="w-full max-w-[480px] bg-white rounded-xl p-10 academic-card border border-[#bdc8d1] relative z-10 shadow-[0_4px_20px_rgba(0,173,239,0.08)]">
                    <div className="text-center mb-10">
                        <h1 className="font-headline-lg text-headline-lg text-on-surface mb-2 font-bold">Forgot Password</h1>
                        <p className="font-body-md text-body-md text-on-surface-variant">Enter your college email to receive a password reset code.</p>
                    </div>
                    ...
                    <div className="mt-10 pt-6 border-t border-outline-variant text-center">
                        <Link className="text-[#00adef] font-label-md hover:underline font-bold flex items-center justify-center" href="/login">
